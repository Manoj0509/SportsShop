...
public class OrderController {
	...
	public ResponseEntity<OrderEntity> addOrder(@PathVariable Long custId)
			throws OrderNotFoundException, InvalidOrderIdException {
		...
		return new ResponseEntity<OrderEntity>(orderDTO, HttpStatus.OK);
	}
	...
	public ResponseEntity<OrderEntity> deleteOrder(@PathVariable long orderID)
			throws OrderNotFoundException, InvalidOrderIdException {
